...
@Component({
    selector: 'app-gov-agency-mior-list',
    templateUrl: './gov-agency-mior-list.component.html',
    styleUrls: ['./gov-agency-mior-list.component.scss']
})
export class GovAgencyMiorListComponent implements OnInit {
    ...
    dictionaryActionNEET: Array<Dictionary>;
    ...
    initCountStatList() {
        this.workspaceService.getStat({
            countCode: GovAgencyService.MIOR_LIST_CODE_PREFIX,
    ...
    private initDictionaries() {
        ...
        this.dictionaryService.getDictionaryGovAction(GovAgencyService.MIOR_NEET_CODE_PREFIX).subscribe({
            next: response => {
                this.dictionaryActionNEET = response;
            }, error: errorResponse => {
