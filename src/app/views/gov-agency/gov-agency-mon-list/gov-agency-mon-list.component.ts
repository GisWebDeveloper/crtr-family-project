...
@Component({
    selector: 'app-gov-agency-mon-list',
    templateUrl: './gov-agency-mon-list.component.html',
    styleUrls: ['./gov-agency-mon-list.component.scss']
})
export class GovAgencyMonListComponent implements OnInit {
    ...
    initCountStatList() {
        this.workspaceService.getStat({
            countCode: GovAgencyService.MON_LIST_CODE_PREFIX,
