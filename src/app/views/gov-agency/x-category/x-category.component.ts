...
@Component({
  selector: 'app-x-category',
  templateUrl: './x-category.component.html',
  styleUrls: ['./x-category.component.scss']
})
export class XCategoryComponent implements OnInit {
    ...
    initCountStatList() {
        this.workspaceService.getStat({
            countParentId: GovAgencyService.X_CATEGORY_PAR_ID,
