...
@Component({
    selector: 'app-gov-agency-mon-report-school',
    templateUrl: './gov-agency-mon-report-school.component.html',
    styleUrls: ['./gov-agency-mon-report-school.component.scss']
})
export class GovAgencyMonReportSchoolComponent implements OnInit {

    @Input() reportCategory: Dictionary;

    reportList: Array<ReportMonSchool> = [];
    reportTotal: ReportMonSchool = new ReportMonSchool();
    ...
    ngOnInit(): void {
        ...
        this.reportService.getReportMonSchool(request).subscribe({
            next: response => {
    ...
    calcTotals(list: Array<ReportMonSchool>) {
        let total = new ReportMonSchool();
