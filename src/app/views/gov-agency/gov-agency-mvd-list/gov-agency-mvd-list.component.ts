...
@Component({
  selector: 'app-gov-agency-mvd-list',
  templateUrl: './gov-agency-mvd-list.component.html',
  styleUrls: ['./gov-agency-mvd-list.component.scss']
})
export class GovAgencyMvdListComponent implements OnInit {
    ...
    initCountStatList() {
        this.workspaceService.getStat({
            countCode: GovAgencyService.MVD_LIST_CODE_PREFIX,
