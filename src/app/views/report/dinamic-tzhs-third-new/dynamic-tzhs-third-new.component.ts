...
@Component({
  selector: 'app-dynamic-tzhs-third-new',
  templateUrl: './dynamic-tzhs-third-new.component.html',
  styleUrls: ['./dynamic-tzhs-third-new.component.scss']
})
export class DynamicTzhsThirdNewComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.dictionaryCount = this.dictionaryCountActive;
        this.params = {
            countCode: '',
    ...
    ngAfterViewInit(): void {
        this.eventSearchStatusStat.emit({search:  'rep_qlik_dynamic', iin: ''});
    }
