...
@Component({
    selector: 'app-kandas-tzhs',
    templateUrl: './kandas-tzhs.component.html',
    styleUrls: ['./kandas-tzhs.component.scss']
})
export class KandasTzhsComponent implements OnInit {
