...
@Component({
    selector: 'app-report-na-by-filter',
    templateUrl: './report-na-by-filter.component.html',
    styleUrls: ['./report-na-by-filter.component.scss']
})
export class ReportNaByFilterComponent implements OnInit {
    ...
    search() {
        if (this.params.countDictionary) {
            ...
            this.utilService.notifyError('Выберитое меру');
        }
    }
