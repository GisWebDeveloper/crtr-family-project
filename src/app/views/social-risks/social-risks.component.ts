...
@Component({
    selector: 'app-social-risks',
    templateUrl: './social-risks.component.html',
    styleUrls: ['./social-risks.component.scss']
})
export class SocialRisksComponent implements OnInit {

    private readonly SOCIAL_RISKS_DICTIONARY_PARENT_ID = 1044;
    ...
    initCountStatList() {
        this.workspaceService.getStat({countParentId: this.SOCIAL_RISKS_DICTIONARY_PARENT_ID, regionId: this.params.filterRegionId}).subscribe({
            next: response => {
