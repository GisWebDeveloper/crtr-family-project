...
@Component({
  selector: 'app-form-pereselentsy',
  templateUrl: './form-pereselentsy.component.html',
  styleUrls: ['./form-pereselentsy.component.scss']
})
export class FormPereselentsyComponent implements OnInit {
