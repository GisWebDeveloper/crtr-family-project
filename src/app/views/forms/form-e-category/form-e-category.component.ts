...
@Component({
  selector: 'app-form-e-category',
  templateUrl: './form-e-category.component.html',
  styleUrls: ['./form-e-category.component.scss']
})
export class FormECategoryComponent implements OnInit {


    @Input() hasAdminPermissions: boolean;
    @Input() eventShowFormECategory: EventEmitter<string>;
    ...
    ngOnInit(): void {
        ...
        this.eventShowFormECategory.asObservable().subscribe(iinValue => {
            this.iin = iinValue;
    ...
    private initPersonCountActions(iin: string) {
        ...
        request.iin = iin;
        request.countCode = GovAgencyService.E_CATEGORY_CODE_PREFIX;
