...
@Component({
  selector: 'app-asp-list',
  templateUrl: './asp-list.component.html',
  styleUrls: ['./asp-list.component.scss']
})
export class AspListComponent implements OnInit {
    visible = [true];
    ...
    private initDictionaries() {
        ...
        this.dictionaryService.getDictionaryGovAction(GovAgencyService.ASP_CODE_PREFIX).subscribe({
            next: response => {
